...
DECLARE_APP(VertexBufferWindow)

const int WIDTH = 800;
const int HEIGHT = 600;

const int VertexBufferWindow::MAX_FRAMES_IN_FLIGHT = 2;
const std::vector<Vertex> VertexBufferWindow::vertices = {
...
const std::vector<uint16_t> VertexBufferWindow::indices = {
	0, 1, 2, 2, 3, 0
};
...
VertexBufferWindow::VertexBufferWindow()
	: currentFrame(0)
{
...
void VertexBufferWindow::recreateSwapChain()
{
	if (device) {
		device.waitIdle();
...
void VertexBufferWindow::cleanupSwapChain()
{
...
void VertexBufferWindow::initVulkan()
{
...
std::vector<const char*> VertexBufferWindow::getRequiredExtensions() {
...
bool VertexBufferWindow::checkValidationLayerSupport() {
	uint32_t layerCount;
...
void VertexBufferWindow::createInstance() {
...
void VertexBufferWindow::setupDebugCallback()
{
...
void VertexBufferWindow::pickPhysicalDevice()
{
	physicalDevice = optimalDevice();
}

bool VertexBufferWindow::isDeviceSuitable(const vk::PhysicalDevice& device) const
{
...
vk::PhysicalDevice VertexBufferWindow::optimalDevice() const
{
...
bool VertexBufferWindow::checkDeviceExtensionSupport(vk::PhysicalDevice device) const {
...
QueueFamilyIndices VertexBufferWindow::findQueueFamilies(const vk::PhysicalDevice& device) const
{
...
void VertexBufferWindow::createLogicalDevice()
{
...
void VertexBufferWindow::createSurface()
{
...
SwapChainSupportDetails VertexBufferWindow::querySwapChainSupport(const vk::PhysicalDevice& device) const
{
...
vk::SurfaceFormatKHR VertexBufferWindow::chooseSwapSurfaceFormat(const std::vector<vk::SurfaceFormatKHR>& availableFormats) const
{
...
vk::PresentModeKHR VertexBufferWindow::chooseSwapPresentMode(const std::vector<vk::PresentModeKHR>& availablePresentModes) const
{
...
vk::Extent2D VertexBufferWindow::chooseSwapExtent(const vk::SurfaceCapabilitiesKHR& capabilities) const
{
...
void VertexBufferWindow::createSwapChain()
{
...
void VertexBufferWindow::createImageViews()
{
...
void VertexBufferWindow::createRenderPass()
{
...
void VertexBufferWindow::createGraphicsPipeline() {
...
vk::ShaderModule VertexBufferWindow::createShaderModule(const std::vector<char>& code) {
...
void VertexBufferWindow::createFramebuffers()
{
...
void VertexBufferWindow::createCommandPool()
{
...
void VertexBufferWindow::createCommandBuffers()
{
...
void VertexBufferWindow::createSyncObjects()
{
...
void VertexBufferWindow::drawFrame()
{
...
void VertexBufferWindow::createVertexBuffers()
{
...
void VertexBufferWindow::createIndexBuffers()
{
...
uint32_t VertexBufferWindow::findMemoryType(uint32_t typeFilter, vk::MemoryPropertyFlags properties)
{
...
void VertexBufferWindow::createBuffer(
	vk::DeviceSize size,
...
void VertexBufferWindow::copyBuffer(vk::Buffer srcBuffer, vk::Buffer dstBuffer, vk::DeviceSize size)
{
	vk::CommandBufferAllocateInfo allocInfo = vk::CommandBufferAllocateInfo()
		.setLevel(vk::CommandBufferLevel::ePrimary)
		.setCommandPool(commandPool)
